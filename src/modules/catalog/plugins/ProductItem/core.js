...
const ProductItem = (props) => {
    ...
    const CustomerFooter = (params) => {
        ...
        const classActionWishlistCompareHoverItem = `absolute items-center top-[-55px] z-10 opacity-0 transition-opacity !duration-500
            group-hover/itemPLP:opacity-100 right-[calc(50%-40px)]`;
        return (
            <div className="flex flex-col gap-2 tablet:gap-4">
                ...
                <div className="hidden tablet:flex desktop:flex flex-row gap-1 justify-center items-center w-full">
                    <Show when={showAddToCart && !viewItemOnly}>
                        <Button
                            ...
                            className={classNames(
                                ...
                                'hover:shadow-[0_0_0_4px] hover:opacity-[0.8]',
                            )}
                        >
                    ...
                    <div className={classNames('to-cart-compare', classActionWishlistCompareHoverItem)}>
                        <Show when={showAddToCart && viewItemOnly}>
                            <Button
                                className={classNames(
                        ...
                        <Show when={showWishlist || showProductCompare}>
                            <div className={classNames(
                                'flex-row gap-1 hidden tablet:flex desktop:flex',
                            )}
                            >
            ...
            <>
                ...
                <div
                    className={classNames(
                        ...
                        'flex flex-col swift-catalog-item-product group/itemPLP',
                        className,
                    )}
                >
